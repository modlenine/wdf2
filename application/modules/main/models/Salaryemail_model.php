...
class Salaryemail_model extends CI_Model
{
   ...
   function createQrcode_sal($linkQrcode, $id)
   {
      // $obj = new emailfn();
   ...
   {
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่รอตรวจสอบวงเงิน";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่รอตรวจสอบวงเงิน</h2>
         <table>
         <tr>
         ...
         <tr>
            ...
            <td colspan="3"><a href="' . base_url('salary_view.html/') . $formcode."/".$formno . '">' . $formno . '</a></td>
         </tr>

         <tr>
            <td><strong>Scan QrCode</strong></td>
            <td colspan="3"><img src="' . base_url('uploads/qrcode/') . $this->createQrcode_sal($short_url,$formno) . '"></td>
         </tr>
   ...
   {
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่ รอผู้จัดการอนุมัติ";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่ รอผู้จัดการอนุมัติ</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
   ...
   {
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่ รอบัญชี(AP)ตรวจสอบ";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่ รอบัญชี(AP)ตรวจสอบ</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
   ...
   public function send_to_excutive($formcode , $formno)
   {
      ...
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่ รอผู้บริหารกลุ่ม $emaildata->wdf_appgroup อนุมัติ";

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่ รอผู้บริหารกลุ่ม '.$emaildata->wdf_appgroup.' อนุมัติ</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
   ...
   {
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่ รอบัญชี(Assist Manager , Manager)ตรวจสอบ";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่ รอบัญชี(Assist Manager , Manager)ตรวจสอบ</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
   ...
   {
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่ รอบัญชี(Finance)ตรวจสอบ";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่ รอบัญชี(Finance)ตรวจสอบ</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
   ...
   {
      $subject = "[$formno] มีรายการใบขอเบิกจ่าย (salary) ใหม่ รอผู้ร้องขอเซ็นรับเงิน";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ใหม่ รอผู้ร้องขอเซ็นรับเงิน</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
   ...
   {
      $subject = "[$formno] รายการใบขอเบิกจ่าย (salary) ดำเนินการเสร็จสิ้น";
      $short_url = base_url('salary_view.html/') . $formcode."/".$formno;
      $emaildata = getDataForEmail($formcode , $formno , "sal");

      $body = '
         <h2>รายการใบขอเบิกจ่าย (salary) ดำเนินการเสร็จสิ้น</h2>
         <table>
         <tr>
            <td><strong>เลขที่คำขอ</strong></td>
            <td>' . $emaildata->wdf_formno . '</td>
