...
class Main extends MX_Controller {
    ...
    public function version_update()
    {
        $html = "";
        $html .= "
        <h3>Version 1.0.0.11 (31-03-2025)</h3>
            <ul>
                <li>แก้ไขการแสดงผลของเอกสารแต่ละ เส้นให้สามารถแสดงผลรายการหลัก + รายการที่เกี่ยวข้องหรือรายการร่วมได้อย่างถูกต้อง</li>
                <li>แก้ไขการทำงานของ Filter ให้สามารถใช้งานได้ตามปกติ</li>
                <li>แก้ไข รายงานให้แสดงผลของรายการหลัก + รายการร่วมได้อย่างถูกต้อง</li>
            </ul>
            <hr>
        ";
        $html .= "
