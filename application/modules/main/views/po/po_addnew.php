                ...
                <form id="frm_saveDataPoNew" autocomplete="off" style="width:100%;" class="needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="ip-po-userreceive" id="ip-po-userreceive" class="form-control" value="<?=getUser()->Fname." ".getUser()->Lname?>">
                        </div>
                        <div class="col-md-8">
...
<script>
    ...
    $(document).ready(function(){
                    ...
                    <tr>
                        ...
                        <td>
                            <i class="fa fa-trash del-detailList-po" aria-hidden="true"
                                data_detailIndex="`+i+`"
                            ></i>
                            <input hidden type="text" id="input-detailautoid" name="input-detailautoid[]" value="`+po_addDetail_array[i].detailautoid+`">
                        </td>
        ...
        // function getMaximumMoney_po(groupAreaid , doctype)
        // {
        //     if(groupAreaid != "" && doctype != ""){
        //         axios.post(url+'main/po/getMaximumMoney_po' , {
        //             action:"getMaximumMoney_po",
