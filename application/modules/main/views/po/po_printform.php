...
<head>
    ...
    <title>ฟอร์มใบขอเบิกจ่าย (PO)</title>
</head>
<body>
<?php
    ...
    $pdf->SetTitle('ใบขอเบิกจ่าย (PO)');
    $pdf->SetSubject('ใบขอเบิกจ่าย (PO)');
    $pdf->SetKeywords('ใบขอเบิกจ่าย (PO)');
    ...
    <div style="text-align:center;">
        <span style="font-size:26px;"><b>ใบขอเบิกจ่าย (PO)</b></span><br>
