...
<?php
    ...
    $pdf->SetTitle('ใบขอเบิกจ่าย (Normal)');
    $pdf->SetSubject('ใบขอเบิกจ่าย (Normal)');
    $pdf->SetKeywords('ใบขอเบิกจ่าย (Normal)');
    ...
    <div style="text-align:center;">
        <span style="font-size:26px;"><b>ใบขอเบิกจ่าย (Normal)</b></span><br>
