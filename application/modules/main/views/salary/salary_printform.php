...
<?php
    ...
    $pdf->SetTitle('ใบขอเบิกจ่ายเงินเดือน (Salary)');
    $pdf->SetSubject('ใบขอเบิกจ่ายเงินเดือน (Salary)');
    $pdf->SetKeywords('ใบขอเบิกจ่ายเงินเดือน (Salary)');
    ...
    <div style="text-align:center;">
        <span style="font-size:26px;"><b>ใบขอเบิกจ่ายเงินเดือน (Salary)</b></span><br>
    ...
    <table border="1" id="advt_tableViewFull" style="width:1100px">
        <thead>
            <tr>
                ...
                <th width="100px" align="center" style="font-size:16px;"><b>จำนวนเงิน</b></th>
            </tr>
        </thead>
        <tbody>';
