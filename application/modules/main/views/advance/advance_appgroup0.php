                            ...
                            <div class="row">
                                <div class="col-lg-12 form-inline">
                                    <div class="custom-control custom-radio mb-5 ml-3">
                                        ...
                                        <label for="ipv-adv-areaid-sc" class="custom-control-label">อนุมัติ</label>
                                    </div> 
                                    <div class="custom-control custom-radio mb-5 ml-3">
                                        <input type="radio" id="ipv-adv-areaid-pa" name="ipv-adv-areaid" value="pa" class="custom-control-input"> 
                                        <label for="ipv-adv-areaid-pa" class="custom-control-label">ไม่อนุมัติ</label>
                                    </div>
                                </div>
                            </div>
                    </div>
